...
const Footer = () => {
  ...
  return (
    ...
    <footer className="bg-white rounded-lg shadow mt-5  ">
      <div className="w-full max-w-screen-xl md:py-2 bg-gray-100">
        ...
        <div class="flex justify-center items-center ">
          <span className="block text-sm text-gray-500 sm:text-center">© 2023 <span className="hover:underline">EVENTHIVE</span>. All Rights Reserved.</span>
        </div>
      </div>
    </footer>
